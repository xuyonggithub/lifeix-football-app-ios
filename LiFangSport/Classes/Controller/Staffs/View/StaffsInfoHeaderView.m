...
-(void)createSubViews{
    ...
    if(!_model.avatar){
        ...
        NSString *bgImageUrl = [NSString stringWithFormat:@"%@%@?imageView/1/w/105/h/140", kQiNiuHeaderPathPrifx, _model.avatar];
    ...
    UILabel *nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(140 - 15, 10, SCREEN_WIDTH - 140 - 120 - 15, 20)];
