...
- (void)setupPageControl
{
    ...
    pageControl.indicatorMargin = 13;
    pageControl.hidesForSinglePage = YES;
    pageControl.minHeight = 6;
    pageControl.pageIndicatorTintColor = HEXRGBACOLOR(0x000000,0.1);
    pageControl.currentPageIndicatorTintColor = HEXRGBACOLOR(0x000000,0.3);
