...
static NSString *kMMRingStrokeAnimationKey = @"AJMediaIndicatorView.stroke";
static NSString *kMMRingRotationAnimationKey = @"AJMediaIndicatorView.rotation";

@interface AJMediaIndicatorView ()
@property (nonatomic, readonly) CAShapeLayer *progressLayer;
@property (nonatomic, readwrite) BOOL isAnimating;
@end

@implementation AJMediaIndicatorView
