...
- (void)addConstraint {
    ...
    tanName.tintColor = [UIColor blackColor];
    ...
    gButton.tintColor = [UIColor blackColor];
    ...
    newPeopleButton.tintColor = [UIColor blackColor];
    ...
    recommendPeopleButton.tintColor = [UIColor blackColor];
