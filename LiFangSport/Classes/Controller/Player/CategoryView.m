...
-(void)showContent{
    ...
    for(int i = 0; i < numOfCategory; i++){
        NSDictionary *attribute = [NSDictionary dictionaryWithObject:[UIFont systemFontOfSize: 21] forKey:NSFontAttributeName];
    ...
    if(self.categaryScrollView.contentSize.width < SCREEN_WIDTH){
        for(int i = 0; i < numOfCategory; i++){
            ...
            [button setTitleColor:HEXRGBCOLOR(0x5f5f5f) forState:UIControlStateNormal];
            ...
            lineView.lineColor = RGBCOLOR(173, 19, 27);
