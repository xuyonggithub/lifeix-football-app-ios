 ...
 */
#define OVERLAY_ACTIVITY_DEFAULT_COLOR	[UIColor colorWithRed:255.0/255.0 green:255.0/255.0 blue:255.0/255.0 alpha:1.0]
 ...
 */
#define OVERLAY_PROGRESS_COLOR          [UIColor colorWithRed:255.0/255.0 green:255.0/255.0 blue:255.0/255.0 alpha:1.0]

/**
 * Thickness of success, error, warning and info icons.
 */
#define OVERLAY_ICON_THICKNESS  4.0
...
#define LABEL_PADDING_TEXT_Y    20
...
@property (nonatomic, strong) CAShapeLayer             *icon;
@property (nonatomic, strong) CAShapeLayer             *ringBgIcon;
...
@property (nonatomic) CGSize overlayRectSize;
